...
const DIAMANT_FORTIS_SERIES = [
  ...
  { theme: 'Tactile Reality', design: '플레인 캔버스', series: 'DF012', colors: { '01': '코튼 크림', '02': '코튼 화이트', '03': '실버 코튼', '04': '프로스트 토프', '05': '로즈 더스트', '06': '크리미 머스타드' } },
...
const DIAMANT_FORTIS_SAMPLES: Sample[] = DIAMANT_FORTIS_SERIES.flatMap(({ theme, design, series, colors }) =>
  Object.entries(colors).map(([variant, color]) => {
    ...
    return {
      ...
      image: `/images/wallpaper/diamant-fortis/${productNo}.jpg`,
...
const DIAMANT_SAMPLES: Sample[] = DIAMANT_SERIES.flatMap(({ theme, design, colors }) =>
  Object.entries(colors).map(([productNo, color]) => ({
    ...
    image: `/images/wallpaper/diamant/${productNo}.jpg`,
